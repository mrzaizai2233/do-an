...
use common\models\Search\SearchOptionValue;
...
class OptionValueController extends Controller
{
    ...
    {    
        $searchModel = new SearchOptionValue();
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new OptionValue",
                    'content'=>'<span class="text-success">Create OptionValue success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing OptionValue model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing OptionValue model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
