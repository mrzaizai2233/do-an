...
use common\models\search\SearchThuonghieu;
...
class ThuongHieuController extends Controller
{
    ...
    {
        return ['contact' => 'custom for contact action access error'];
    }
    public function actionIndex()
    {
        $searchModel = new SearchThuonghieu();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $isNhanVien = (new User())->checkUser('nhanvien');
            ...
            */
            ...
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title' => "Create new Thuonghieu",
                    'content' => '<span class="text-success">Create Thuonghieu success</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
