...
<div class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="breadcrumb clearfix">
            ...
            <span class="navigation_page"><?=$tenloaihang?></span>
        </div>
        <!-- ./breadcrumb -->
        <!-- row -->
        <div class="row">
            ...
            <div class="column col-xs-12 col-sm-3" id="left_column">
                                    ...
                                    <ul class="deals-product-list owl-carousel" data-dots="false" data-loop="true" data-nav = "true" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3,"margin":20},"1000":{"items":1}}'>
                                        <li>
                                            <div class="product-conatainer">
                                                <div class="product-thumb">
                                                    <a href="#">
                                                        <img src="<?= Yii::$app->urlManager->createUrl('frontend/giaodien/giaodien1/assets/data/ld2.jpg')?>" alt="Product">
                                                    </a>
                                                </div>
                                        ...
                                        <li>
                                            <div class="product-conatainer">
                                                <div class="product-thumb">
                                                    <a href="#">
                                                        <img src="<?= Yii::$app->urlManager->createUrl('frontend/giaodien/giaodien1/assets/data/ld1.jpg')?>" alt="Product">
                                                    </a>
                                                </div>
                                                <div class="product-info">
                                                    <div class="show-count-down">
                                        ...
                                        <li>
                                            <div class="product-conatainer">
                                                <div class="product-thumb">
                                                    <a href="#">
                                                        <img src="<?= Yii::$app->urlManager->createUrl('frontend/giaodien/giaodien1/assets/data/ld3.jpg')?>" alt="Product">
                                                    </a>
                                                </div>
                                                <div class="product-info">
                                                    <div class="show-count-down">
                        ...
                        <div class="layered layered-filter-price">
                            ...
                            <div class="layered-content">
                                <ul class="check-box-list">
                                    <?php  foreach($loaihangs as $index => $loaihang):?>
                                    <li>
                                        <input type="checkbox" id="c<?=$index?>" name="cc" />
                                        <label for="c<?=$index?>">
                                            <span class="button"></span>
                                            <?= $loaihang->tenloaihang?><span class="count">(<?=count($loaihang->hanghoas)?>)</span>
                                        </label>
                                    </li>
                                    <?php endforeach; ?>
                                </ul>
                ...
                <div class="col-left-slide left-module">
                    <ul class="owl-carousel owl-style2" data-loop="true" data-nav = "false" data-margin = "30" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-items="1" data-autoplay="true">
                        <li><a href="#"><img src="<?= Yii::$app->urlManager->createUrl('frontend/giaodien/giaodien1/assets/data/slide-left.jpg')?>" alt="slide-left"></a></li>
                        <li><a href="#"><img src="<?= Yii::$app->urlManager->createUrl('frontend/giaodien/giaodien1/assets/data/slide-left2.jpg')?>" alt="slide-left"></a></li>
                        <li><a href="#"><img src="<?= Yii::$app->urlManager->createUrl('frontend/giaodien/giaodien1/assets/data/slide-left3.jpg')?>" alt="slide-left"></a></li>
                    </ul>
                        ...
                        <ul class="products-block">
                            <li>
                                <div class="products-block-left">
                                    <a href="#">
                                        <img src="<?= Yii::$app->urlManager->createUrl('frontend/giaodien/giaodien1/assets/data/product-100x122.jpg')?>" alt="SPECIAL PRODUCTS">
                                    </a>
                                </div>
                ...
                <div class="block left-module">
                    ...
                    <div class="block_content">
                        <div class="tags">
                            <!-- layered -->     <a href="#"><span class="level1">actual</span></a>
                        ...
                        <ul class="testimonials owl-carousel" data-loop="true" data-nav = "false" data-margin = "30" data-autoplayTimeout="1000" data-autoplay="true" data-autoplayHoverPause = "true" data-items="1">
                            <li>
                                ...
                                <div class="client-avarta">
                                    <img src="<?= Yii::$app->urlManager->createUrl('frontend/giaodien/giaodien1/assets/data/testimonial.jpg')?>" alt="client-avarta">
                                </div>
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <div class="category-slider">
                    <ul class="owl-carousel owl-style2" data-dots="false" data-loop="true" data-nav = "true" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-items="1">
                        <li>
                            <img src="<?= Yii::$app->urlManager->createUrl('frontend/giaodien/giaodien1/assets/data/category-slide.jpg')?>" alt="category-slider">
                        </li>
                        <li>
                            <img src="<?= Yii::$app->urlManager->createUrl('frontend/giaodien/giaodien1/assets/data/slide-cart2.jpg')?>" alt="category-slider">
                        </li>
                    </ul>
                </div>
                <!-- ./category-slider -->
                        ...
                        <ul class="row">
                            <li class="col-sm-3">
                                <div class="product-container">
                                    <div class="product-thumb">
                                        <a href="#"><img src="<?= Yii::$app->urlManager->createUrl('frontend/giaodien/giaodien1/assets/data/sub-cat1.jpg')?>" alt="Product"></a>
                                    </div>
                                    <h5 class="product-name">
                            ...
                            <li class="col-sm-3">
                                <div class="product-container">
                                    <div class="product-thumb">
                                        <a href="#"><img src="<?= Yii::$app->urlManager->createUrl('frontend/giaodien/giaodien1/assets/data/sub-cat2.jpg')?>" alt="Product"></a>
                                    </div>
                                    <h5 class="product-name">
                            ...
                            <li class="col-sm-3">
                                <div class="product-container">
                                    <div class="product-thumb">
                                        <a href="#"><img src="<?= Yii::$app->urlManager->createUrl('frontend/giaodien/giaodien1/assets/data/sub-cat3.jpg')?>" alt="Product"></a>
                                    </div>
                                    <h5 class="product-name">
                            ...
                            <li class="col-sm-3">
                                <div class="product-container">
                                    <div class="product-thumb">
                                        <a href="#"><img src="<?= Yii::$app->urlManager->createUrl('frontend/giaodien/giaodien1/assets/data/sub-cat4.jpg')?>" alt="Product"></a>
                                    </div>
                                    <h5 class="product-name">
                ...
                <div id="view-product-list" class="view-product-list">
                    <h2 class="page-heading">
                        <span class="page-heading-title"><?= $tenloaihang ?></span>
                    </h2>
                            ...
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="<?=Yii::$app->urlManager->createUrl(['site/product','code'=>$hanghoa->code])?>">
                                        <img class="img-responsive" alt="product" src="<?= Yii::$app->urlManager->createUrl('images/'.base::checkImageProduct($hanghoa))?>" />
                                    </a>
                                ...
                                <div class="right-block">
                                    ...
                                    <div class="content_price">
                                        <span class="price product-price"><?=number_format($hanghoa->dongia, 0, ',', '.')?></span>
                                    </div>
                                    <div class="info-orther">
                                        <p>Item Code: #<?=$hanghoa->code ?></p>
                                        <p class="availability">Availability: <span><?=base::getTinhTrang1($hanghoa->tinhtrang) ?></span></p>
                                        <div class="product-desc">
                                            <?= $hanghoa->motangangon ?>
                                        </div>
                                    </div>
                                    <div class="add-to-cart" data-id="<?=$hanghoa->code?>">
